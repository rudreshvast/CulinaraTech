...
export function HeroSection() {
  return (
    <>
      <section
        className="relative min-h-screen flex items-center bg-[#fdfaf5] overflow-hidden"
      ...
      >
        ...
        <div
          className="absolute top-[60px] right-[80px] z-0"
          style={{ opacity: 0.1 }}
        >
          <div
            className="w-1 h-1 bg-[#1a5c38] rounded-full absolute"
            style={{ top: 0, left: 0 }}
          />
          <div
            className="w-1.5 h-1.5 bg-[#1a5c38] rounded-full absolute"
          ...
          />
          <div
            className="w-2 h-2 bg-[#1a5c38] rounded-full absolute"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-1.5 bg-[#e8f5ee] border border-[#b8dcc8] rounded-full px-3.5 py-1.5 mb-6">
                <div
                  className="w-1.5 h-1.5 bg-[#1a5c38] rounded-full"
              ...
              {/* Headline */}
              <h1
                className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-[#1a1a1a]"
                style={{
              ...
              >
                ...
                <span className="block relative inline-block">
                  to{" "}
                  <span className="relative inline-block text-[#d4870a]">
                    Factory Floor
                    <span
              ...
              <p className="text-lg mb-8 text-[#6b6b6b] max-w-md leading-relaxed">
                Bridge the gap between your food technology degree and real
                industry practice. Learn from experts at Nestlé, ITC, Britannia,
                and 10+ leading food companies.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-semibold text-[#1a1a1a]">
                    Join 2,400+ food technology students
                  </div>
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #fef3e2 0%, #e8f5ee 100%)",
                }}
              />
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-[#1a1a1a] mt-1.5 leading-snug">
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  <span className="text-[#d4870a] font-semibold text-xs">
                    ★ 4.7
                  </span>
                ...
                <div className="mt-2">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-[10px] font-semibold text-[#1a5c38]">
                      65%
                    </span>
                  </div>
              ...
              >
                ...
                <h3 className="text-xs font-semibold text-[#1a1a1a]">
                  QA Intern — Nestlé India
                </h3>
                <div className="text-xs font-semibold text-[#1a5c38] mt-1">
                  ₹15,000/month
                </div>
              ...
              >
                ...
                <div className="inline-flex items-center gap-1 mt-2 bg-[#fef3e2] rounded-full px-2 py-1">
                  ...
                  <span className="text-[10px] font-semibold text-[#d4870a]">
                    10 seats left
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <div className="mt-1.5">
                  <div className="text-[10px] text-[#6b6b6b] mb-1">
                    11 seats left
                  </div>
