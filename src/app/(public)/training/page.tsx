...
export default function TrainingPage() {
  ...
  const getTypeColor = (type: string) => {
    return type === 'Workshop' ? 'bg-blue-500/20 text-blue-600' : 'bg-green-500/20 text-green-600';
  };
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-12">
          <h1 className="text-5xl font-bold text-on-surface mb-4">
            Enhance Your <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Skills</span>
          </h1>
        ...
        <div className="space-y-8">
          {filteredOpportunities.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-on-surface mb-2">No training found</h3>
              ...
              <div className="overflow-y-auto flex-1 px-8 py-6">
                <div className="space-y-8">
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold text-on-surface uppercase tracking-widest">Type</h3>
                    <div className="space-y-2 border-l-2 border-primary/40 pl-5 ml-0">
                      {uniqueTypes.map(type => (
                        <label key={type} className="flex items-center gap-4 cursor-pointer group p-3 rounded-xl hover:bg-surface-container-low transition-colors -ml-3">
                          <input
                            type="checkbox"
                          ...
                          />
                          <span className="text-on-surface group-hover:text-primary transition-colors font-medium flex-1 text-base">{type}</span>
              ...
              <div className="overflow-y-auto flex-1 px-6 md:px-8 py-6 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-surface-container-lowest p-4 rounded-2xl border border-outline">
                    ...
                    <p className="text-on-surface font-bold">{selectedOpportunity.stipend === 'Free' ? 'Free' : selectedOpportunity.stipend}</p>
                  </div>
                  <div className="bg-surface-container-lowest p-4 rounded-2xl border border-outline">
                    <div className="flex items-center gap-2 text-on-surface-variant text-sm mb-1">
